...
uint256 hashGenesisBlock("0x88f8aa3de082aa49a7af5e24141e8d86f6e717b3bdd3e06170b7cea79ba43b25");
...
const string strMessageMagic = "eReal Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // eReal: 0.35 days
static const int64 nTargetSpacing = 15; // eReal: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eReal miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "eReal", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        block.nVersion = 1;
        block.nTime    = 1499690181;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088508467;
        ...
        assert(block.hashMerkleRoot == uint256("ef7e256a2cf2d38576225af2775a1e8160928a0c78526ab3615615d1ff16870e"));
